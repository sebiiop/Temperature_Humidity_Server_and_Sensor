...
float temp_offset = 0.00; //offset value for temperature
float hum_offset = 0.00; //offset value for humidity
float battery_calibration = 0.00; // Check Battery voltage using multimeter & add/subtract the value
